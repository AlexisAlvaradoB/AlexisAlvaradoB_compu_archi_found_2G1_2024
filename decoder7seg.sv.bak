...
//a	
assign out[0] = ~(number == 4'b0010 || number == 4'b0011 || number == 4'b0101 || number == 4'b0110 || number == 4'b0111 || number == 4'b1000 || number == 4'b1001 || number == 4'b1010 || number == 4'b1100 || number == 4'b1110 || number == 4'b1111);
//b
...
//d
assign out[3] = ~(number == 4'b0000 || number == 4'b0010 || number == 4'b0011 || number == 4'b0101 || number == 4'b0110 || number == 4'b1000 || number == 4'b1001 || number == 4'b1010 || number == 4'b1011 || number == 4'b1100 || number == 4'b1101 || number == 4'b1110);
//e
...
//f
assign out[5] = ~(number == 4'b0000 || number == 4'b0100 || number == 4'b0101 || number == 4'b0110 || number == 4'b1000 || number == 4'b1001 || number == 4'b1011 || number == 4'b1100 || number == 4'b1110 || number == 4'b1111);
//g
